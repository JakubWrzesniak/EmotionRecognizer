...
class Add_lr_scheduler(tk.Frame):
    ...
    def create_view(self):
        ...
        self.radio_monitor = [tk.Radiobutton(self.parent, text=MONITOR_VAR[i], variable=self.monitor_var, value=MONITOR_VAR[i])
        ...
        self.scale_min_lr = tk.Scale(self.parent, from_=0., to=0.0000009, resolution=0.0000001, orient=tk.HORIZONTAL,
        ...
        self.label_monitor.grid(row=1, column=0, sticky=W)
        self.label_min_delta.grid(row=2, column=0, sticky=W)
        self.label_factor.grid(row=3, column=0, sticky=W)
        self.label_patience.grid(row=4, column=0, sticky=W)
        self.label_min_lr.grid(row=5, column=0, sticky=W)
        self.label_verbose.grid(row=6, column=0, sticky=W)


        self.input_name.grid(row=0, column=1, sticky=W)
        for i in range(len(self.radio_monitor)):
            self.radio_monitor[i].grid(row=1, column=1 + i, sticky=W)
        self.scale_mid_delta.grid(row=2, column=1, sticky=W)
        self.scale_factor.grid(row=3, column=1, sticky=W)
        self.scale_patience.grid(row=4, column=1, sticky=W)
        self.scale_min_lr.grid(row=5, column=1, sticky=W)
        self.scale_verbose.grid(row=6, column=1, sticky=W)
